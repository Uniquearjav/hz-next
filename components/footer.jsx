...
function Footer() {
  return (<footer className="text-gray-600 dark:bg-black dark:text-white body-font">
  ...
  <div className="dark:bg-black bg-gray-100">
    <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
      ...
      <p className="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4">© 2024 Horizaura —
        <a href="https://twitter.com/horizaura" rel="noopener noreferrer" className="text-gray-600 ml-1" target="_blank">@horizaura</a>
      </p>
