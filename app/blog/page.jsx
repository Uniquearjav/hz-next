...
export default function Blogs() {
    ...
    <li className="relative flex flex-col sm:flex-row xl:flex-col items-start">
        ...
        </div><Image src="/media/products/HZ1.jpg" alt="" className="mb-6 shadow-md rounded-lg bg-slate-50 w-full sm:w-[17rem] sm:mb-0 xl:mb-6 xl:w-full" width={1216} height={640} />
    </li>
    <li className="relative flex flex-col sm:flex-row xl:flex-col items-start">
        <div className="order-1 sm:ml-6 xl:ml-0">
            <h3 className="mb-1 text-slate-900 font-semibold dark:text-slate-200">
    ...
    <li className="relative flex flex-col sm:flex-row xl:flex-col items-start">
        ...
        </div><Image src="/media/products/HZ1.jpg" alt="" className="mb-6 shadow-md rounded-lg bg-slate-50 w-full sm:w-[17rem] sm:mb-0 xl:mb-6 xl:w-full" width={1216} height={64} />
    </li>
</ul>
        </main>
    )
