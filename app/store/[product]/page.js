    ...
    return (
        <div>
            ...
            <div class="container px-5 py-24 mx-auto">
                ...
                <Image width={4000} height={4000} alt={`${ProductData.name}, ID - ${ProductData.product_id}, Price - Rs. ${ProductData.price}`} class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src={`/media/products/${ProductData.product_id}.jpg`} />
